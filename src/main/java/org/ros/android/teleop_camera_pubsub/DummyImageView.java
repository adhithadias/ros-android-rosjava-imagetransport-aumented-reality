...
public class DummyImageView<T> extends android.support.v7.widget.AppCompatImageView implements NodeMain {
    ...
    public DummyImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DummyImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onStart(ConnectedNode connectedNode) {
        ...
        Subscriber<T> imageSubscriber = connectedNode.newSubscriber("/cv_camera/image_resize/compressed", sensor_msgs.CompressedImage._TYPE);
